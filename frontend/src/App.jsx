...
import { triggerFlow } from "./services/api";
              ...
              <TR key={emp.id} hover>
                ...
                <TD>
                  <div style={{ display: "flex", gap: 4 }}>
                    ...
                    {emp.type === "parttime" && (
                      <Btn variant="secondary" small onClick={triggerFlow}>
                        📩 Chase
                      </Btn>
                    )}
                  </div>
...
//*********** */
  ...
  const renderView = () => {
    switch (activeView) {
      ...
      // case "projects": return <ProjectsView projects={MOCK_PROJECTS} employees={employees} onSelectProject={handleSelectProject} />;
      case "projectDetail":
        return (
          <ProjectDetail
        ...
        >
          ...
          <nav style={{ flex: 1, padding: "12px 10px", overflow: "auto" }}>
            {NAV_ITEMS.map((item) => {
              const isActive =
                activeView === item.id ||
                (item.id === "projects" && activeView === "projectDetail");
              return (
                <button
                  key={item.id}
                  onClick={() => {
